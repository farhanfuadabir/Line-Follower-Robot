...
uint16_t threshold[8] = {800, 800, 800, 800, 800, 800, 800, 800};
...
// const uint8_t maxSpeed = 220;
// const uint8_t baseSpeed = 150;
// uint16_t Kp = 60; //70;		// 70 @ rmax 255
// uint16_t Kd = 200; //250;		// 250 @ rmax 255

uint8_t maxSpeed = 255; // reverse
uint8_t baseSpeed = 200;
uint16_t Kp = 65; //70;		// 70 @ rmax 255
uint16_t Kd = 300; //250;		// 250 @ rmax 255

uint8_t speedFlag = 0;
uint8_t rightSkipFlag = 0;
uint8_t sonarFlag = 0;
// const uint8_t maxSpeed = 220;
// const uint8_t baseSpeed = 180;
// uint16_t Kp = 50; //70;		// 70 @ rmax 255
...
// 		{
// 			sonarFlag = 1;
// 			while (sensorCount == 0 && allFlag == 0 && rightFlag == 0 && leftFlag == 0)
// 			{
// 				sensorValueConversion();
// 			}
// 		}
...
// 		if (rightFlag == 1 && weightedValue < 7 && weightedValue > 3 && rightSkipFlag == 1)
// 		{
// 			Forward();
// 			_delay_ms(300);
// 			rightSkipFlag = 0;
