...
// const uint16_t compareValue[8] = {550, 600, 600, 600, 600, 600, 600, 450};
const uint16_t compareValue[8] = {800, 850, 850, 850, 850, 850, 850, 650};
...
// 			Stop();
// // 			_delay_ms(5000);
// 			for(int confidence_level = 0; confidence_level < 5; confidence_level++) 
// 			{
// 				sensorValueConversion();
// 				sensorMapping();
// 				if (mappedValue != 100 || mappedValue != -100)
...
// 				{
// 					Stop();
// // 					_delay_ms(1000); //need correction
// 					RightSharp();
// 					_delay_ms(150);
// 				}
// 				
