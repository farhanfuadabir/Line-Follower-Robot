...
// // 			RightSharp();
// // 			Serial_sendString("R:	");
// // 			Serial_sendInt(confidenceLevel, DEC);
// // 			Serial_sendString("\n");
// // 			confidenceLevel = 0;
// // 		}
// // 	}
...
// // 	}
// 
// 		if (mappedValue == 125/* || mappedValue == 110*/)
// 		{
// 			// 			Stop();
// 			// 			_delay_ms(200);
// 			// 			for (int temp = 0; temp < 10; temp++)
...
// 					break;
// 				}
// 			if (confidenceLevel > 17)
// 				{
// 					Backward();
// 					_delay_ms(50);
// 					RightSharp();
// 					_delay_ms(200);
// 					while(mappedValue > 80) //15
// 					{
// 						sensorValueConversion();
// 						sensorMapping();
// 					}
...
// 		}
// 		
// 		else if (mappedValue == -125/* || mappedValue == 110*/)
// 		{
// 			// 			Stop();
// 			// 			_delay_ms(200);
// 			// 			for (int temp = 0; temp < 10; temp++)
...
// 
// 
// 	if (mappedValue == 120 || mappedValue == 120 || sensorValue == 0xFF)
// 	{
// 		sensorValueConversion();
// 		sensorMapping();
// 	}
